...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .and()
            .authorizeRequests()
                // Let browsers perform CORS preflight
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // For local admin UI demo (served from http://localhost:5500) and other localhost ports.
        // Using patterns keeps this flexible (and avoids "*" with allowCredentials=true).
